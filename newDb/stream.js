...
// COPY products (id, name, shortDes, midDes, cImg, oImg, price, rating, nRev) FROM './report.csv' WITH (FORMAT csv)

// `COPY ikeaProducts (id, name, shortDes, midDes, cImg, oImg, price, rating, nRev) FROM '${csvPath}' DELIMITER ',' CSV HEADER`
